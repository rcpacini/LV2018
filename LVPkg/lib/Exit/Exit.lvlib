...
<Library LVVersion="18008000">
	...
	<Item Name="Exit Check.vi" Type="VI" URL="../Exit Check.vi"/>
	<Item Name="Exit Refs.vi" Type="VI" URL="../Exit Refs.vi"/>
	<Item Name="Exit User Event.vi" Type="VI" URL="../Exit User Event.vi"/>
